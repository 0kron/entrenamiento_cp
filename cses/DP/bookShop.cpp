...
int main() {
	...
	// at index price you store the max pages you can buy for that price
	...
	for (int i = 0; i < n; i++){
		...
		// The reason for this is that once you buy a book,
		// you always move to the left in the table:  money - price = money left (<-)
